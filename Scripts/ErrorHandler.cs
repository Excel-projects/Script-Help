...
namespace ScriptHelp.Scripts
{
    ...
    public class ErrorHandler
    {
        ...
        public static void SetLogPath()
        {
			...
			//string logFileName = System.IO.Path.Combine(Properties.Settings.Default.App_PathDeploy, AssemblyInfo.Product + ".log");
			string logFileName = System.IO.Path.Combine(Properties.Settings.Default.App_PathFileListing, AssemblyInfo.Product + ".log");
